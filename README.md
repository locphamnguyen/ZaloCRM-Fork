...
- **🤖 AI Assistant** — Gợi ý trả lời, tóm tắt hội thoại, phân tích cảm xúc khách hàng ([PR #1](https://github.com/locphamnguyen/zalocrm/pull/1))
- **⚡ Workflow Automation** — Tự động gửi tin nhắn, phân loại khách hàng, trigger theo sự kiện ([PR #2](https://github.com/locphamnguyen/zalocrm/pull/2))
- **🔗 Integration Hub** — Tích hợp Google Sheets, Telegram, Facebook, Zapier ([PR #3](https://github.com/locphamnguyen/zalocrm/pull/3))
- **📱 Mobile PWA** — Giao diện responsive, hoạt động offline, cài đặt trên điện thoại ([PR #4](https://github.com/locphamnguyen/zalocrm/pull/4))
- **🧠 Contact Intelligence** — Gộp trùng khách hàng, lead scoring, auto-tag ([PR #5](https://github.com/locphamnguyen/zalocrm/pull/5))
- **📊 Advanced Analytics** — Phân tích funnel, hiệu suất team, thời gian phản hồi, report builder ([PR #6](https://github.com/locphamnguyen/zalocrm/pull/6))
- **🔧 Multi-Provider AI** — Hỗ trợ Anthropic, OpenAI, Qwen, Kimi với cấu hình linh hoạt ([PR #8](https://github.com/locphamnguyen/zalocrm/pull/8))
- **🌐 Proxy per-account** — Cấu hình proxy HTTP riêng cho từng tài khoản Zalo, tránh block IP ([PR #9](https://github.com/locphamnguyen/zalocrm/pull/9))
- **🐛 Fix: Tin nhắn trùng lặp** — Loại bỏ tin nhắn hiển thị trùng khi gửi ([PR #7](https://github.com/locphamnguyen/zalocrm/pull/7))
